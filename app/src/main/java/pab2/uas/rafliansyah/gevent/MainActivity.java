...
import pab2.uas.rafliansyah.gevent.databinding.ActivityMainBinding;
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem item) {
                        ...
                        if (idMenu==R.id.action_edit){
                            ...
                            builder.setMessage("Yakin Ingin Menghapus "+data.get(position).getNamaevent()+ data.get(position).getAlamat()+data.get(position).getDeskripsi()+"?");
